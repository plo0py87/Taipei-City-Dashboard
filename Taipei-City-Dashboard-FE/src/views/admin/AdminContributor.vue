	...
	<div class="admincontributor">
		...
		<div class="admincontributor-bar">
			<button @click="handleAddContributor">
				{{ i18nStore.$t("views.AdminContributor.新增貢獻者") }}
			</button>
		</div>
			...
			<thead>
				<tr class="admincontributor-table-header">
					...
					<TableHeader min-width="150px">
						{{ i18nStore.$t("views.AdminContributor.名稱") }}
					</TableHeader>
					<TableHeader min-width="150px">
						{{ i18nStore.$t("views.AdminContributor.圖片") }}
					</TableHeader>
					<TableHeader min-width="200px">
						{{ i18nStore.$t("views.AdminContributor.連結") }}
					</TableHeader>
					<TableHeader min-width="200px">
						{{ i18nStore.$t("views.AdminContributor.建立時間") }}
					</TableHeader>
					<TableHeader min-width="200px">
						{{ i18nStore.$t("views.AdminContributor.更新時間") }}
					</TableHeader>
				</tr>
			</thead>
			...
			>
				<div class="admincontributor-nocontent-content">
					...
					<h2>
						{{
							i18nStore.$t(
								"views.AdminContributor.發生錯誤，無法載入貢獻者列表"
							)
						}}
					</h2>
				</div>
			...
			<div v-else class="admincontributor-nocontent">
				<div class="admincontributor-nocontent-content">
					...
					<h2>
						{{
							i18nStore.$t(
								"views.AdminContributor.查無符合篩選條件的貢獻者"
							)
						}}
					</h2>
				</div>
		...
		<div class="admincontributor-control">
			<label for="pagesize">{{
				i18nStore.$t("views.AdminContributor.每頁顯示")
			}}</label>
